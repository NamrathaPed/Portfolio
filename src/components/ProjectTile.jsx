...
export const ProjectTile = ({
    ...
    return (
        <div className="space-y-6 xl:flex xl:space-x-6 w-4/5 md:w-3/5 mx-auto shadow-4xl bg-slate-800 hover:border-2 hover:border-teal-300 hover:scale-105 transition-transform p-10 rounded-xl">
