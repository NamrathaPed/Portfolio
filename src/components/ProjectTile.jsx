...
export const ProjectTile = ({
    ...
    return (
        <div className="space-y-6 xl:flex w-[350px] h-[600px] shadow-4xl bg-slate-800 hover:border-2 hover:border-teal-300 hover:scale-105 transition-transform p-10 rounded-xl scroll-smooth">
